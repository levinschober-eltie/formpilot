...
const S_DRAWER_LEFT = { position: 'absolute', top: 0, left: 0, bottom: 0, width: '280px', background: S.colors.bgCardSolid, boxShadow: S.colors.shadowLg, overflowY: 'auto', padding: '16px', paddingBottom: '80px' };
const S_DRAWER_RIGHT = { position: 'absolute', top: 0, right: 0, bottom: 0, width: 'min(360px, 90vw)', background: S.colors.bgCardSolid, boxShadow: S.colors.shadowLg, overflowY: 'auto', padding: '16px', paddingBottom: '80px' };
