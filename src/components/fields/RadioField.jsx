...
export const RadioField = React.memo(({ field, value, onChange, error, ...rest }) => (
  <div role="radiogroup" aria-label={field.label} aria-describedby={rest['aria-describedby']} style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
    {(field.options || []).map(o => (
